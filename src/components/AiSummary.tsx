...
export function AiSummary() {
  return (
    <div className="relative overflow-hidden rounded-xl">
      ...
      <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-[#4F46E5] via-[#6D5BF7] to-[#8B7CF7] p-[1px]">
      ...
      <div className="relative p-5">
        ...
        <div className="flex items-center gap-2.5 mb-3">
          <div className="flex items-center justify-center h-7 w-7 rounded-lg bg-gradient-to-br from-[#4F46E5] to-[#7C6DF7] shadow-md shadow-[#4F46E5]/25">
